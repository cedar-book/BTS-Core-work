...
**`create_account_with_brain_key`**  - Creates a new account and registers it on the blockchain.
...
**`register_account`**  - Registers a third party’s account on the blockckain.
