--> thought... have to have a **lifetime membership** to register an account. not?
...
You will need to have a brain key and a public key when you register an account. Run the `suggest_brain_key` command in the CLI Wallet. 
