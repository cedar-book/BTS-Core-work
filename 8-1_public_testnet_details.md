...
ref http://docs.bitshares.eu/testnet/public-testnet.html

-----

We produdly present the first [public testnet](http://testnet.bitshares.eu/) based on graphene and took the opportunity to construct a tutorial from the process.
