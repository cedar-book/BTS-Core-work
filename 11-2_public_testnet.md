...
[The Open Public Testnet](http://testnet.bitshares.eu/) ([technical details] (--> 11.1:-Public-Testnet-Details))


# How to deploy your own Public Network

1. [Installation/Confguration of Witness](#1-installation_confguration-of-witness)
2. [Genesis Configuration](#2-genesis-configuration)
3. [Initializing Blockchain](#3-initializing-blockchain)
4. [Connecting a CLI walle](#4-connecting-a-cli-wallet)
5. [Establish a Committee](#5-establish-a-committee)
6. [Web Wallet](#6-web-wallet)
7. [Set up the Faucet](#7-set-up-the-faucet)
8. [Nignx Webserver](#8-nignx-webserver)
...
## 1. Installation_Confguration of Witness 
